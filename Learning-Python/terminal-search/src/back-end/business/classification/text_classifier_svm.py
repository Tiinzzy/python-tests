...
if __name__ == "__main__":
    classifier = TextClassifierSVM('../data/full-dataset.csv')
    classifier.train_model()
    classifier.save_model('../data/recipe_classifier_svm_model')
    path_to_model_file = '../data/recipe_classifier_svm_model'
